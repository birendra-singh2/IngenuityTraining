...
function palandrome(str: string): boolean {
...
console.log(10_00_00_000);
console.log((10_00_00_000).toExponential(3));
...
console.log(d.filter((day) => day.charAt(0) !== "T"));
console.log(d.filter((day) => day.includes("e")));

console.log(b.map((num, i) => (typeof num === "number" ? num + i : 0)));

console.log(b.forEach((num, i, arr) => arr[i] = (typeof num === "number" ? num * i : 0)));
console.log(b);
...
const clockDiv = <HTMLDivElement>document.querySelector("#clock");
